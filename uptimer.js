...
client.ayarlar = { "token": "TOKEN", "prefix": "PREFİX", "sahip": "SAHİPİD" };

client.on('message', async msg => {
  if (msg.content === `<@789435653627838485>`) return msg.channel.send(`Prefixim ${ayarlar.prefix}`);
});
...
client.user.setActivity(`Özelden: ${client.ayarlar.prefix}link ekle/liste/sil url/hepsi | YunusEmre#0001 Tarafından Yapılmıştır.`)
